...
const StoryInspirationCard: React.FC<StoryInspirationCardProps> = ({ story }) => {
  ...
  return (
    <div ref={cardRef} className="motion-card group relative bg-white border border-gray-100 hover:border-indigo-500/40 rounded-2xl overflow-hidden shadow-sm flex flex-col h-full transition-colors duration-300 dark:bg-slate-900/50 dark:border-none dark:shadow-xl">
